...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://localhost/v2';

    /**
     * User agent of the HTTP request, set to "PHP-TCB" by default
     *
     * @var string
     */
    protected $userAgent = 'TCB-Codegen/1.0.0/php';
    ...
    {
        $report  = 'PHP SDK (Thecodebunny\StreamingEngine) Debug Report:' . PHP_EOL;
